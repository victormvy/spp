...
\begin{document}
	...
	Also, other evaluation metrics have been used to ease the comparison with other works: Minimum Sensitivity (MS), Mean Absolute Error (MAE), Mean Squared Error (MSE), Correct Classification Rate (CCR), Top-2 CCR, Top-3 CCR and 1-off accuracy.
	...
	\subsection{Adience}
	\label{sect:adience}
	Results for the experiments made with the Adience dataset are shown in Table \ref{table:AdienceTest}.
	
	\begin{table*}[!t]
		\caption{Adience test results. BS stands for Batch Size, LR for Learning Rate and LF for link function.}
...
%			BS & LR & LF & $QWK_{val}$ & $QWK_{test}$\\\hline
...
%	\end{table}
	...
	The results of the ANOVA III test for the Adience dataset are shown in Table \ref{table:ANOVAAdience}. The interactions where there are not significative differences in QWK means have been omitted. First, we observe that there exist significative differences in the mean QWK concerning the three factors (p-values $0.000$). Secondly, we found interactions between the following pairs of factors: the link function and the learning rate, the link function and the batch size and, the batch size and the learning rate. Also, there are interactions between all the factors together.
	
	As we did for the DR dataset, a post-hoc multiple comparison test has been performed on the average QWK obtained for this dataset too. Under the null hypothesis that the variance of the error of the dependent variable is the same between groups, an HSD Tukey's test has been done. The results showed that the best link function is the logit one, in this case, with $0.8265$ as mean QWK value. Also, there are significative differences between this function and the probit link (p-value $0.000$), that has a mean QWK value of $0.7810$. Both links functions present significative differences concerning the complementary log-log function, that has a mean value of $0.7434$.
	
	The same methodology was followed for the learning rate and the batch size factors. The test reported significative differences between $\eta=10^{-3}$ (mean value $0.8636$) and the rest of values of this parameter, being this one the best value for this factor. The best value after $10^{-3}$ is $10^{-2}$, which have a mean QWK value of $0.8177$. Both values present significative differences with $\eta=10^{-4}$, that has a mean QWK value of $0.6697$.
	
	Lastly, the best value for the batch size parameter is $128$ (mean value $0.8024$) as it has significative differences with the rest of values. The second best value is $256$ (mean $0.7877$), and it has significative differences with $64$, that has a mean value of $0.7609$.
	
	However, the interactions between these factors made the configuration that uses a logit link, $\eta=10^{-3}$ and batch size of 64, the best configuration. It obtained a mean QWK value of $0.9396$ for validation and $0.8808$ for test. The same parameters, but using the probit link, achieves the second best results.
	...
	The best batch size for DR was 10 while the best value for Adience was 128. Both values are the median value that we have tried.
...
%			 Dataset & BS & LR & $\overline{\text{QWK}}_{{(SD)}}$ & $\overline{\text{MS}}_{{(SD)}}$ & $\overline{\text{MAE}}_{{(SD)}}$ & $\overline{\text{MSE}}_{{(SD)}}$ & $\overline{\text{CCR}}_{{(SD)}}$ & $\overline{\text{Top-2}}_{{(SD)}}$ & $\overline{\text{Top-3}}_{{(SD)}}$ & $\overline{\text{1-off}}_{{(SD)}}$\\\hline
%			 DR & 5 & $10^{-2}$ & $0.205_{(0.060)}$ & $0.032_{(0.035)}$ & $0.269_{(0.009)}$ & $0.138_{(0.011)}$ & $0.527_{(0.035)}$ & $0.827_{(0.028)}$ & $0.952_{(0.006)}$ & $0.673_{(0.064)}$\\
%			 DR & 5 & $10^{-3}$ & $0.265_{(0.118)}$ & $0.096_{(0.078)}$ & $0.265_{(0.014)}$ & $0.128_{(0.007)}$ & $0.525_{(0.044)}$ & $0.816_{(0.012)}$ & $0.957_{(0.004)}$ & $0.699_{(0.103)}$\\
%			 DR & 5 & $10^{-4}$ & $0.445_{(0.027)}$ & $0.147_{(0.032)}$ & $0.229_{(0.009)}$ & $0.109_{(0.005)}$ & $0.660_{(0.038)}$ & $0.856_{(0.008)}$ & $0.969_{(0.003)}$ & $0.836_{(0.008)}$\\
%			 DR & 10 & $10^{-2}$ & $0.300_{(0.050)}$ & $0.093_{(0.056)}$ & $0.260_{(0.007)}$ & $0.125_{(0.004)}$ & $0.569_{(0.027)}$ & $0.819_{(0.017)}$ & $0.949_{(0.007)}$ & $0.717_{(0.054)}$\\
%			 DR & 10 & $10^{-3}$ & $0.399_{(0.010)}$ & $0.215_{(0.029)}$ & $0.247_{(0.003)}$ & $0.118_{(0.002)}$ & $0.578_{(0.026)}$ & $0.826_{(0.006)}$ & $0.963_{(0.001)}$ & $0.798_{(0.007)}$\\
%			 DR & 10 & $10^{-4}$ & $0.497_{(0.011)}$ & $0.157_{(0.040)}$ & $0.209_{(0.002)}$ & $0.098_{(0.002)}$ & $0.692_{(0.012)}$ & $0.865_{(0.002)}$ & $0.972_{(0.001)}$ & $0.854_{(0.006)}$\\
%			 DR & 15 & $10^{-2}$ & $0.368_{(0.062)}$ & $0.133_{(0.048)}$ & $0.244_{(0.011)}$ & $0.116_{(0.005)}$ & $0.616_{(0.032)}$ & $0.836_{(0.022)}$ & $0.958_{(0.010)}$ & $0.775_{(0.044)}$\\
%			 DR & 15 & $10^{-3}$ & $0.416_{(0.029)}$ & $0.186_{(0.028)}$ & $0.241_{(0.006)}$ & $0.115_{(0.003)}$ & $0.600_{(0.017)}$ & $0.839_{(0.011)}$ & $0.963_{(0.004)}$ & $0.800_{(0.025)}$\\
%			 DR & 15 & $10^{-4}$ & $0.486_{(0.007)}$ & $0.185_{(0.051)}$ & $0.210_{(0.007)}$ & $0.099_{(0.004)}$ & $0.671_{(0.022)}$ & $0.861_{(0.007)}$ & $0.971_{(0.002)}$ & $0.854_{(0.006)}$\\
%			 \hline
%			 Adience & 64 & $10^{-2}$ & $0.779_{(0.013)}$ & $0.100_{(0.072)}$ & $0.152_{(0.007)}$ & $0.089_{(0.003)}$ & $0.447_{(0.021)}$ & $0.712_{(0.014)}$ & $0.838_{(0.013)}$ & $0.795_{(0.019)}$\\
%			 Adience & 64 & $10^{-3}$ & $0.787_{(0.004)}$ & $0.115_{(0.026)}$ & $0.139_{(0.002)}$ & $0.110_{(0.001)}$ & $0.458_{(0.008)}$ & $0.685_{(0.007)}$ & $0.802_{(0.003)}$ & $0.800_{(0.007)}$\\
%			 Adience & 64 & $10^{-4}$ & $0.627_{(0.023)}$ & $0.024_{(0.025)}$ & $0.165_{(0.009)}$ & $0.119_{(0.014)}$ & $0.365_{(0.032)}$ & $0.581_{(0.028)}$ & $0.712_{(0.017)}$ & $0.701_{(0.009)}$\\
%			 Adience & 128 & $10^{-2}$ & $0.762_{(0.013)}$ & $0.124_{(0.033)}$ & $0.141_{(0.002)}$ & $0.116_{(0.001)}$ & $0.443_{(0.007)}$ & $0.685_{(0.009)}$ & $0.812_{(0.007)}$ & $0.790_{(0.009)}$\\
%			 Adience & 128 & $10^{-3}$ & $0.768_{(0.007)}$ & $0.100_{(0.025)}$ & $0.140_{(0.002)}$ & $0.112_{(0.003)}$ & $0.454_{(0.009)}$ & $0.667_{(0.008)}$ & $0.783_{(0.004)}$ & $0.791_{(0.004)}$\\
%			 Adience & 128 & $10^{-4}$ & $0.586_{(0.033)}$ & $0.016_{(0.022)}$ & $0.175_{(0.009)}$ & $0.116_{(0.010)}$ & $0.321_{(0.050)}$ & $0.565_{(0.023)}$ & $0.711_{(0.014)}$ & $0.665_{(0.013)}$\\
%			 Adience & 256 & $10^{-2}$ & $0.759_{(0.007)}$ & $0.113_{(0.036)}$ & $0.141_{(0.001)}$ & $0.113_{(0.002)}$ & $0.447_{(0.006)}$ & $0.691_{(0.009)}$ & $0.815_{(0.006)}$ & $0.793_{(0.004)}$\\
%			 Adience & 256 & $10^{-3}$ & $0.752_{(0.004)}$ & $0.071_{(0.018)}$ & $0.146_{(0.002)}$ & $0.117_{(0.001)}$ & $0.429_{(0.009)}$ & $0.658_{(0.007)}$ & $0.782_{(0.010)}$ & $0.781_{(0.005)}$\\
%			 Adience & 256 & $10^{-4}$ & $0.480_{(0.094)}$ & $0.022_{(0.041)}$ & $0.180_{(0.007)}$ & $0.111_{(0.008)}$ & $0.326_{(0.024)}$ & $0.539_{(0.028)}$ & $0.682_{(0.028)}$ & $0.616_{(0.041)}$
%		\end{tabular}
%	\end{table*}
	
	As we did in Section \ref{sect:statisticalanalysis}, we must analyse the effect of the batch size (with values 5, 10 and 15 for DR and, 64, 128 and 256 for Adience) and the learning rate ($10^{-2}$, $10^{-3}$ and $10^{-4}$) factors have over the QWK metric. So, we make an ANOVA II analysis for each dataset.
