...
from activations import SPP, SPPT, MPELU, RTReLU, RTPReLU, PairedReLU, EReLU, SQRTActivation, CLM, RReLu, PELU, SlopedReLU, PTELU, Antirectifier, CReLU, EPReLU, ELUPlus, ELUSPPT, Softplusplus
...
class Net:
	...
	def vgg16rn(self):
		...
		model.add(Conv2D(64, (3, 3), padding='same',
						 input_shape=(self.size, self.size, self.num_channels), kernel_initializer=random_normal(seed=1), kernel_regularizer=regularizers.l2(weight_decay)))
		model.add(self.__activation())
		model.add(BatchNormalization())
		model.add(Dropout(0.3, seed=1))

		model.add(Conv2D(64, (3, 3), padding='same', kernel_initializer=random_normal(seed=1), kernel_regularizer=regularizers.l2(weight_decay)))
		model.add(self.__activation())
		model.add(BatchNormalization())

		model.add(MaxPooling2D(pool_size=(2, 2)))

		model.add(Conv2D(128, (3, 3), padding='same', kernel_initializer=random_normal(seed=1), kernel_regularizer=regularizers.l2(weight_decay)))
		model.add(self.__activation())
		model.add(BatchNormalization())
		model.add(Dropout(0.4, seed=1))
		...
		model.add(Conv2D(256, (3, 3), padding='same', kernel_initializer=random_normal(seed=1), kernel_regularizer=regularizers.l2(weight_decay)))
		model.add(self.__activation())
		model.add(BatchNormalization())
		model.add(Dropout(0.4, seed=1))
		...
		model.add(Conv2D(512, (3, 3), padding='same', kernel_initializer=random_normal(seed=1), kernel_regularizer=regularizers.l2(weight_decay)))
		model.add(self.__activation())
		model.add(BatchNormalization())
		model.add(Dropout(0.4, seed=1))
		...
		model.add(Flatten())
		model.add(Dense(512, kernel_regularizer=regularizers.l2(weight_decay), kernel_initializer=random_normal(seed=1)))
		model.add(self.__activation())
		model.add(BatchNormalization())

		model.add(Dropout(0.5, seed=1))
		model.add(Dense(self.num_classes, kernel_initializer=random_normal(seed=1)))
		model.add(Activation('softmax'))
