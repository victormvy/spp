...
class Net:
	...
	def vgg19(self):
		model = keras.models.Sequential([
			# Block 1
			keras.layers.Conv2D(64, 3, strides=(1, 1), kernel_initializer='he_uniform',
			...
			# Block 2
			keras.layers.Conv2D(128, 3, strides=(1, 1), kernel_initializer='he_uniform'),
			self.__get_activation(),
			keras.layers.BatchNormalization(),
			keras.layers.Conv2D(128, 3, strides=(1, 1), kernel_initializer='he_uniform'),
			self.__get_activation(),
			...
			# Block 3
			keras.layers.Conv2D(256, 3, strides=(1, 1), kernel_initializer='he_uniform'),
			self.__get_activation(),
			keras.layers.BatchNormalization(),
			keras.layers.Conv2D(256, 3, strides=(1, 1), kernel_initializer='he_uniform'),
			self.__get_activation(),
			...
			# Block 4
			keras.layers.Conv2D(512, 3, strides=(1, 1), kernel_initializer='he_uniform'),
			self.__get_activation(),
			keras.layers.BatchNormalization(),
			keras.layers.Conv2D(512, 3, strides=(1, 1), kernel_initializer='he_uniform'),
			self.__get_activation(),
